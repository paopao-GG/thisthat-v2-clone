...
describe('Market Data Services', () => {
  ...
  describe('normalizeMarket', () => {
    it('should normalize a complete market correctly', () => {
      ...
      // Per lazy loading pattern, odds/volume/liquidity are NOT stored - fetched on-demand
      ...
      // rawData removed per lazy loading pattern to save space
    ...
    it('should use default values for missing fields', () => {
      ...
      // Per lazy loading pattern, odds are NOT stored - fetched on-demand
      expect(result.thisOdds).toBeUndefined();
      expect(result.thatOdds).toBeUndefined();
